...
export default function SSOTDebugPanel({ wizardData, apiAssumptions }: SSOTDebugPanelProps) {
  ...
  const criticalFields = [
    ...
    { key: 'retirementAge', label: 'Retirement Age', category: 'personal', critical: true },
    { key: 'primaryIncome', label: 'Primary Income', category: 'income' },
    { key: 'spouseIncome', label: 'Spouse Income', category: 'income' },
