  ...
  return (
    <div className="flex flex-col items-center gap-2">
      <button
        ...
        disabled={isDisabled}
        className="inline-flex items-center gap-2 rounded-full bg-black text-white px-6 py-3 text-sm font-medium hover:bg-black/90 disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors"
