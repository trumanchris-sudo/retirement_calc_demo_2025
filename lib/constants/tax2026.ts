...
export function getMax401kContribution(age: number): number {
  if (age >= 60 && age <= 63) {
    return RETIREMENT_LIMITS_2026.TRADITIONAL_401K_LIMIT + RETIREMENT_LIMITS_2026.CATCHUP_60_TO_63;
  } else if (age >= 50) {
    return RETIREMENT_LIMITS_2026.TRADITIONAL_401K_LIMIT + RETIREMENT_LIMITS_2026.CATCHUP_50_PLUS;
  }
